...
public class MainActivity extends AppCompatActivity{
    ...
    ImageView btn_menu;
    LinearLayout btn_profile,btn_home,btn_logout,btn_watch_later,btn_leaderboard,btn_popular_actors,btn_findfriends;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_findfriends = findViewById(R.id.nav_findFriends);
